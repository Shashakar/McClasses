...
public class TileEntityFurnaceSintering extends TileEntity implements IInventory, ITickable
{
    ...
    {
        return this.hasCustomName() ? this.customName : "container.furnace_sintering";
    }
    ...
    public void update()
    {
        ...
        if(!this.world.isRemote)
        {
            ...
            {
                flag1 = true;
                BlockFurnaceSintering.setState(this.isBurning(), this.world, this.pos);
            }
        }
    ...
    private boolean canSmelt()
    {
        ...
        {
            ItemStack result = FurnaceSinteringRecipes.getInstance().getSinteringResult((ItemStack)this.inventory.get(0), (ItemStack)this.inventory.get(1));
    ...
    public void smeltItem()
    {
        if(this.canSmelt())
        {
            ...
            ItemStack result = FurnaceSinteringRecipes.getInstance().getSinteringResult(input1, input2);
            ItemStack output = (ItemStack)this.inventory.get(3);
